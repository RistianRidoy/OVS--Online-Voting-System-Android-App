...
import com.example.ovs.adapter.CandidateResultAdapter;
...
public class Result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultRV = findViewById(R.id.show_result);
        warningtxt = findViewById(R.id.warning_text);
        firebaseFirestore = FirebaseFirestore.getInstance();

        list = new ArrayList<>();
        adapter = new CandidateResultAdapter(Result.this, list);
        resultRV.setLayoutManager(new LinearLayoutManager(Result.this));
            ...
            firebaseFirestore.collection("Candidate").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(Result.this, "CANDIDATE NOT FOUND", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
